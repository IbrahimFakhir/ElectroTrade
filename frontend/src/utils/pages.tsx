...
const relativeAdminPath: string = "/admin";
...
pages.set('admin', { name: "Admin", path: relativeAdminPath, anchorable: false });
...
export { pages, pageIcons, relativePagesPath, relativeAdminPath } ;
